...
async function main() {
  ...
  let implAddress = OUTPUT_DEPLOY[network.name]["CINEX"].implAddress;
  ...
  console.log(`[CINEX][Implementation]: Start of Verification...`);
  try {
  ...
  console.log(`[CINEX][Implementation]: Verification finished!`);
